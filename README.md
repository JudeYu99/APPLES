...
## 2. Usage
  ...
  ```  
  8) The input of the program is a PDB file containing multiple chains and users can choose the chains they need. Before running ***Run_APPLES.py***, please modify line 39, line 40 for PDB chain identifiers, line 41 for PDB files, line 108 for DSSP path and line 129 for threshold of residue performance. Then, change the working directory into ***codes*** folder and run the following command.
  ```
